              ...
              <div key={item.id} className='flex items-center gap-4 p-2 bg-white rounded-md'>
                ...
                <div className='flex justify-between w-full items-center'>
                  <div>
                    ...
                    <p className='text-gray-800'>NPR{item.price} <span className='line-through text-gray-500'>NRPR{item.price + 10}</span></p>
                  </div>
          ...
          cart.length > 0 && (
            <div className='bg-white rounded-md p-4 mt-4 space-y-1'>
              ...
              <div className='flex justify-between items-center'>
                ...
                <p className='text-green-600'><span className='text-gray-600 line-through px-2'>NPR.50</span>FREE</p>
              </div>
              <div className='flex justify-between items-center'>
                <h1 className='flex gap-1 items-center text-gray-700'><span><GiShoppingBag/></span>Handling charge</h1>
                <p className='text-green-600'>NPR.10</p>
              </div>
              <div className='flex justify-between items-center'>
                <h1 className='font-semibold text-lg'>Grand Total</h1>
                <p className='font-semibold text-lg'>NPR.{totalPrice +5}</p>
              </div>
        ...
        cart.length > 0 && (
          <div className='bg-white p-5 rounded-md'>
              <div className='bg-green-600 text-white w-full py-2 px-3 rounded-md flex justify-between items-center cursor-pointer'>
                <div>
                  <h1 className='font-semibold'>NPR.{totalPrice + 5}</h1>
